...
const { Option } = Select;
const ChangeInfo = (props: IProps) => {
    const { openModalUpdate, setOpenModalUpdate, setDataUpdate, dataUpdate } = props;
                    ...
                    <Row gutter={[16, 16]}>
                        <Col span={12} md={12} xs={24}>
                            ...
                            <Form.Item<FieldType> labelCol={{ span: 24 }} label="Email" name="email" rules={emailRules}>
                                <Input type="email" placeholder="Vui lòng điền email" disabled />
                            </Form.Item>
